...
* Ability to show or hide "Scroll To Top" button at home, CMS, category, product, and any other pages
* Support left and right position to display "Scroll To Top" button
* Ability to display "Scroll To Top" in form of arrows or button
* Ability to configure the "Scroll To Top" from the backend
* Mobile-friendly
* Support multiple-stores


<img src="https://www.ulmod.com/media/ulmod/product_content/umscrolltop-page.png">
